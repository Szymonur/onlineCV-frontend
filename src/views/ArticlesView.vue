    ...
    <div class="c-articles">
        ...
        <div v-else class="articles-container">
            ...
            <div class="article-grid header">
                ...
                <div></div>
                <div
                    class="citation-header bottom-align mobile-do-not-display"
                    style="grid-column: span 3"
                >
                    {{ t("citation_count") }}
                </div>
                <div class="bottom-align mobile-do-not-display">
                    {{ t("year") }}
                </div>
            </div>
            ...
            <!-- Articles list -->
            <div
                v-for="article in ArticlesStore.data"
                :key="article.title"
                class="article-grid row"
            >
                <div>
                    <h2>
